...
import { automationSnapshot, completeAutomationResult, runAutomations, setAutomationActive } from '@/lib/automations';
...
export async function POST(request: NextRequest) {
  ...
  try {
    if (body.action === 'toggle' && isFlowId(body.flowId) && typeof body.active === 'boolean') {
